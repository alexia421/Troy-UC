    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-48,-5.4),Math.toRadians(-44))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-25,-28),Math.toRadians(-44))
                        .afterTime(0.1, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(-2))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-65,-21),Math.toRadians(-44))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-42,-44),Math.toRadians(-44))
                        .afterTime(0.5, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(5))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-83,-36),Math.toRadians(-39))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-53,-67),Math.toRadians(-39))
                        .afterTime(0.1, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(3))
                        .build()
        );
