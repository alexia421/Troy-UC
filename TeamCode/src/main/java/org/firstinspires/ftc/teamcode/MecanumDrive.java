...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.28101479157681636; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 8.616403338931264;

        // feedforward parameters (in tick units)
        public double kS = 0.9237577201935885;//1.2882862147417913
        public double kV = 0.2039415526668855;//0.2039415526668855
        public double kA = 0.04;//0.05
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration+0.4) {
