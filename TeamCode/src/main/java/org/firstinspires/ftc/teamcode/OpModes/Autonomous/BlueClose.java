...
public class BlueClose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        GLOBALS.TARGET_TPS = GLOBALS.CloseVelAuto;
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-44,11),Math.toRadians(44))
                        .build()
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-25,29),Math.toRadians(44))
                        .afterTime(0.1, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(-10))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-62.1,27.6),Math.toRadians(44))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-41,47.8),Math.toRadians(44))
                        .afterTime(0.5, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(-13))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-83,38),Math.toRadians(44))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        ...
                        .strafeToLinearHeading(new Vector2d(-56,66.5),Math.toRadians(44)) //58,62
                        .afterTime(0.3, () -> {
                            motoare.IntakeStop();
                            servos.setRetracted();
                        })
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-50,0),Math.toRadians(-8))
                        .build()
        );
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(drive.pose.position.x, drive.pose.position.y), drive.pose.heading.toDouble()))
                        .strafeToLinearHeading(new Vector2d(-37,22),Math.toRadians(-44))
                        .build()
        );
