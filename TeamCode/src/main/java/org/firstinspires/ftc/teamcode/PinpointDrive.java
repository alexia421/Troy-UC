...
public class PinpointDrive extends MecanumDrive {
    public static class Params {
        ...
        public double xOffset = 5.3708661417;//2.7559055118
        public double yOffset = -2.6815354331;//2.7815354331
         ...
         */
        //public double encoderResolution = 18.5879 ;
    ...
    public PinpointDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        if (PARAMS.usePinpointIMUForTuning) {
            lazyImu = new LazyImu(hardwareMap, PARAMS.pinpointDeviceName, new RevHubOrientationOnRobot(RevHubOrientationOnRobot.LogoFacingDirection.UP,
